public class Driver {
    public static void main(String[] args) {
        ...
        System.out.println(almostDone + " ?= [ab, cd, ef, happy birthday to me, gh, ij, kl, mn, op, qr]");
        ...
        System.out.println(almostDone + " ?= [ab, cd, ef, happy birthday to me, gh, ij, kl, mn, op, qr, sad day to you]");
        ...
        System.out.println(almostDone + " ?= [ab, cd, ef, gh, ij, kl, mn, op, qr]");
        //PART 4 testing #12
